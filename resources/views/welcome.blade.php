        ...
        <header class="px-5 sm:px-10 md:px-10 md:py-5 lg:px-20 flex items-center justify-between">
            ...
            <div x-data="{ navOpen: false }">
                ...
                <div :class="{'hidden': !navOpen}"
                    class="md:block fixed top-0 inset-x-0 bg-white p-8 m-4 z-30 rounded-lg shadow md:rounded-none md:shadow-none md:p-0 md:m-0 md:relative md:bg-transparent">
                    ...
                    <div class="flex flex-col items-center justify-center md:block">
                        <a href="/admin/login" class="transition-all duration-100 ease-in-out pb-1 border-b-2 text-indigo-500 border-transparent hover:border-indigo-300
              hover:text-gray-600 md:mr-8 text-lg md:text-sm font-bold tracking-wide my-4 md:my-0">
                            Admin Login
                        </a>
                        <a href="#" onclick="return alert('Not public yet')" class="transition-all duration-100 ease-in-out pb-1 border-b-2 text-indigo-500 border-transparent hover:border-indigo-300
              hover:text-indigo-600 md:mr-8 text-lg md:text-sm font-bold tracking-wide my-4 md:my-0">
                            Employer Login
                        </a>

                        <a href="#" onclick="return alert('Not public yet')"
                            class="border border-transparent rounded-full font-semibold tracking-wide text-lg md:text-sm px-5 py-3 md:py-2
                        focus:outline-none focus:shadow-outline bg-indigo-600 text-gray-100 hover:bg-indigo-800
                        hover:text-gray-200 transition-all duration-300 ease-in-out my-4 md:my-0 w-full md:w-auto">Employer
                            Sign
                            Up</a>
                    </div>
                </div>
        ...
        <main>
                ...
                <div class="px-5 sm:px-10 md:px-10 md:flex lg:block lg:w-1/2 lg:max-w-3xl lg:mr-8 lg:px-20">
                    <div class="md:w-1/2 md:mr-10 lg:w-full lg:mr-0">
                        <h1 class="text-3xl xl:text-4xl font-black md:leading-none xl:leading-tight">
                            Hire a Developer Near You
                        </h1>
                        <p class="mt-4 xl:mt-2">
                            World Class Developers, just for you on contract, full-time or part-time, whatever you need.
                        </p>
                    </div>
                    ...
                    <div class="flex-1">
                        <div class="relative mt-4 md:mt-0 lg:mt-4">
                            <div class="pl-4 pr-4 h-full absolute bottom-0 left-0 flex items-center">
                                <svg class="text-gray-700 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                            ...
                            <input type="text"
                                class="w-full border bg-gray-100 px-4 py-4 text-sm tracking-wide focus:outline-none focus:shadow-outline rounded-full pl-12"
                        ...
                        <div>
                            <button
                                class="transition-all duration-300 mt-5 w-full border border-transparent rounded-full font-semibold tracking-wide text-sm px-5 py-4 focus:outline-none focus:shadow-outline bg-indigo-500 text-gray-100 hover:bg-indigo-600 hover:text-gray-200">Find
                                Developers</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="px-5 sm:px-10 md:px-20 lg:px-10 xl:px-20 py-8 bg-indigo-100" id="features">
                <div class="max-w-screen-xl mx-auto">
                    ...
                    <div
                        class="flex flex-col items-center flex-wrap lg:flex-row lg:items-stretch lg:flex-no-wrap lg:justify-between">
                        <div
                            class="w-full max-w-sm mt-6 lg:mt-8 bg-gray-100 rounded shadow-lg p-12 lg:p-8 lg:mx-4 xl:p-12">
                            <div class="p-4 inline-block bg-indigo-200 rounded-lg">
                                <svg class="text-indigo-500 w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
                            ...
                            <div class="text-sm">
                                We guarantee that every Developer you ever work with will be an awesome member for your
                                team. We
                                conduct personal interview with every Developer to ensure that we only get the best.
                            </div>
                        </div>
                        ...
                        <div class="w-full max-w-sm mt-8 bg-gray-100 rounded shadow-lg p-12 lg:p-8 lg:mx-4 xl:p-12">
                            <div class="p-4 inline-block bg-green-200 rounded-lg">
                                <svg class="text-green-500 w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
                        ...
                        <div class="w-full max-w-sm mt-8 bg-gray-100 rounded shadow-lg p-12 lg:p-8 lg:mx-4 xl:p-12">
                            <div class="p-4 inline-block bg-red-200 rounded-lg">
                                <svg class="text-red-500 w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
            ...
            <div class="px-5 sm:px-10 md:px-20 lg:px-10 xl:px-20 py-8 bg-gray-100" id="cards">
                <div class="max-w-screen-xl mx-auto">
                    <h3 class="leading-none font-black text-3xl">Popular Developers</h3>
                    ...
                    <div class="lg:flex justify-between lg:mt-8">
                        <div class="lg:mx-2 flex flex-col items-center">
                            <div class="flex-1 flex w-full max-w-sm pt-16 lg:pt-0">
                                <div class="w-full p-8 sm:p-12 lg:px-8 xl:px-12 shadow-lg rounded bg-gray-100 relative">
                                    <div class="text-lg font-bold text-gray-700 leading-tight">Senior Developer -
                                        Laravel
                                    </div>
                                    <div>
                                        <div class="flex justify-between mt-6 text-xs font-bold">
                                            <div class="flex items-start">
                                                <svg class="text-gray-400 w-4" xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <div class="flex items-start ml-4">
                                                <svg class="text-gray-400 w-4" xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                    <rect xmlns="http://www.w3.org/2000/svg" x="2" y="7" width="20"
                                                        height="14" rx="2" ry="2" />
                                                    <path xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div
                                            class="text-center flex flex-row flex-wrap justify-between items-center text-xs font-bold">
                                            ...
                                            <span class="w-5/12 mt-6 mx-1 p-1 rounded bg-blue-200 text-blue-600">4 Years
                                                Exp</span>
                                            <span
                        ...
                        <div class="lg:mx-2 flex flex-col items-center">
                            <div class="flex-1 flex w-full max-w-sm pt-16 lg:pt-0">
                                <div class="w-full p-8 sm:p-12 lg:px-8 xl:px-12 shadow-lg rounded bg-gray-100 relative">
                                    <div class="text-lg font-bold text-gray-700 leading-tight">Design Leader- Nest-JS
                                    </div>
                                    <div>
                                        <div class="flex justify-between mt-6 text-xs font-bold">
                                            <div class="flex items-start">
                                        ...
                                        <div
                                            class="text-center flex flex-row justify-between flex-wrap items-center text-xs font-bold">
                                            <span
                        ...
                        <div class="lg:mx-2 flex flex-col items-center">
                            <div class="flex-1 flex w-full max-w-sm pt-16 lg:pt-0">
                                <div class="w-full p-8 sm:p-12 lg:px-8 xl:px-12 shadow-lg rounded bg-gray-100 relative">
                                    <div class="text-lg font-bold text-gray-700 leading-tight">Junior Developer -
                                        Tailwind & Next-JS
                                    </div>
                                    <div>
                                        <div class="flex justify-between mt-6 text-xs font-bold">
                                        ...
                                        <div
                                            ...
                                            <span
                                                class="w-5/12 mt-6 mx-1 p-1 rounded bg-indigo-200 text-indigo-600">Remote</span>
                                            <span class="w-5/12 mt-6 mx-1 p-1 rounded bg-blue-200 text-blue-600">2 Years
                                                Exp</span>
                                            <span
        ...
        <footer class="px-5 sm:px-10 md:px-20 py-8">
            <div class="flex flex-col items-center lg:flex-row-reverse justify-between">
                ...
                <div class="mt-4 text-xs font-bold text-gray-500">
                    &copy; 2022 PSS | All rights reserved
                </div>
            </div>
        </footer>
    </div>
