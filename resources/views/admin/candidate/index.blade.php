...
{{-- https://cdn.datatables.net/buttons/2.3.2/js/buttons.colVis.min.js --}}
...
<x-common.card>
    ...
    <div class="overflow-x-auto">
        ...
        @component('components.common.card_title', ['title' => 'Employers', 'route' => 'addEmployer', 'button_text' =>
        'Create'])
        @endcomponent
